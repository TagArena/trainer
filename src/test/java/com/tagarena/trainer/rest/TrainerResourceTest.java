...
class TrainerResourceTest {
    ...
    void createTrainers_amount2_saved_2trainers() {
        ...
        TrainerEntity trainerMock1 = new TrainerEntity(1L, "Test", List.of(1L));
        TrainerEntity trainerMock2 = new TrainerEntity(2L, "Test", List.of(1L));

        when(trainerRepository.saveAll(any())).thenReturn(List.of(trainerMock1, trainerMock2));

        TrainerCreationDto TrainerCreationDto = new TrainerCreationDto(2L, List.of(1L));
        List<TrainerDto> result = trainerResource.createTrainers(TrainerCreationDto);

        assertEquals(2, result.size());
        TrainerDto expectedTrainer1 = new TrainerDto(1L, "Test", List.of(1L));
        assertEquals(expectedTrainer1, result.getFirst());
        TrainerDto expectedTrainer2 = new TrainerDto(2L, "Test", List.of(1L));
    ...
    void createTrainers_name_generated() {
        ...
        when(trainerRepository.saveAll(any())).thenReturn(List.of(new TrainerEntity(1L, "Test", List.of(1L))));

        TrainerCreationDto TrainerCreationDto = new TrainerCreationDto(1L, List.of(1L));
    ...
    void getTrainer_mapping_correct() {
        ...
        TrainerEntity mockTrainerEntity = new TrainerEntity(1L, "Test", List.of(1L));
        ...
        TrainerDto expected = new TrainerDto(1L, "Test", List.of(1L));
    ...
    void update_trainer_mapping_correct() {
        ...
        TrainerEntity trainerMock2 = new TrainerEntity(3L, "Test", List.of(1L));
        ...
        TrainerDto requestTrainer = new TrainerDto(4L, "Test1", List.of(1L));
        TrainerDto result = trainerResource.updateTrainer(3L, requestTrainer);

        TrainerDto expected = new TrainerDto(3L, "Test1", List.of(1L));
        assertEquals(expected, result);
